...
- **[Agentic Avatars](../../../KALTURA_CONVERSATIONAL_AVATAR_API.md)** — AI-powered conversational video avatars built on the intelligent-agents-sdk (`@kaltura/intelligent-agents`). Server-side provisioning and token minting, browser conversation runtime, GenUI, Presenter-guided walkthroughs, AI-disclosure gate.
